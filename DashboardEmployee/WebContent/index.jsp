...
<body>
 <div>
            ...
            <ul class="nav navbar-nav" role="tablist">
                ...
                <li class="nav-item"><a class="nav-link" href="login.jsp" target="iframe"
                  ...
                  <li class="nav-item"><a class="nav-link" href="empregister.jsp" target="iframe"
                        style="color: white">EmpRegister</a></li> 
                  
                   <li class="nav-item"><a class="nav-link" href="contactus.jsp" target="iframe"
    ...
    <iframe src="home.jsp" id="iframe" name="iframe" style="width: 100%;height: 430px;border: none"></iframe>
