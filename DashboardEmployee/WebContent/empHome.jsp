...
<body>
 <div>
    ...
    <nav class=" navbar-inverse" style="background-color:rgb(44, 126, 194)">
        ...
        <div class="collapse navbar-collapse" id="myNavbar" style="font-size:18px;">
            <ul class="nav navbar-nav" role="tablist">
                <li class="nav-item"><a class="nav-link active" href="uhome.jsp" target="iframe"style="color: white">Home</a></li>
                  <li class="nav-item"><a class="nav-link" href="viewEmpprofile.jsp" target="iframe"
                        style="color: white">View profile</a></li>
           
                            <li class="nav-item"><a class="nav-link" href="Viewpayslip.jsp" target="iframe"
                        style="color: white">View EmployeePayslip</a></li>
    ...
    <iframe src="uhome.jsp" id="iframe" name="iframe" style="width: 100%;height: 450px;border: none"></iframe>
